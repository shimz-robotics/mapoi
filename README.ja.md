...
| v0.5.0 migration (service 名前空間 `mapoi/` 化 + GetRoutePois success + PointOfInterest.id 削除 + SelectMap フィールド rename + REST API URL 再編 + PoiEvent 簡素化) | [docs/migration/v0.5.0.md](./docs/migration/v0.5.0.md) |
