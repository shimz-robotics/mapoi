...
- topic 名 namespace 化 (`mapoi_*_marks` → `mapoi/*_markers`) — [#102](https://github.com/shimz-robotics/mapoi/issues/102)
- system tag spec 整理 (`origin` / `pause` 削除、`radius` field 削除) — [#89](https://github.com/shimz-robotics/mapoi/issues/89)
- marker (rviz) topic 構成の整理 — [#70](https://github.com/shimz-robotics/mapoi/issues/70)
