...
| v0.4.0 migration (`mapoi_nav_server` → `mapoi_nav2_bridge` rename) | [docs/migration/v0.4.0.md](./docs/migration/v0.4.0.md) |
...
Docker で試したい場合は [docs/docker.md](./docs/docker.md) を参照してください。
