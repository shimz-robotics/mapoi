...
- `PoiEvent` の event 種別簡素化 (`ENTER` / `EXIT` / `STOPPED` / `RESUMED` の 4 種から `ENTER` / `PAUSED` / `EXIT` の 3 種へ、route 走行 + pause タグ連携にスコープを絞る) — [#220](https://github.com/shimz-robotics/mapoi/issues/220) (v0.4.0 リリース直後着手予定)
